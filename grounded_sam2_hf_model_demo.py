...
parser.add_argument("--text-prompt", default="tomatoes. lettuce. cucumbers. bell_pepper. cheese. carrots. pickles. olives. juice. water. sauces.")
parser.add_argument("--img-path", default="images/test.jpg")
